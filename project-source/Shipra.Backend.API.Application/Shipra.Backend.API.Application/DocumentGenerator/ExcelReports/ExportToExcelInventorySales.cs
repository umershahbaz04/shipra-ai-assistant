...
public class ExportToExcelInventorySales
{
  public byte[] ExportToExcel(dynamic data, string title)
  {
    ...
    if (!IsDataEmpty)
    {
       ...
       dataTable.Columns.Remove("ClientName");
    }
    #endregion

    string[] columnsToTake = { "StationName", "StoreName", "ProductName", "SKU", "OrderNo", "FullFillmentStatus", "Discount", "Quantity", "Price" };
    bool showSrNo = true;
