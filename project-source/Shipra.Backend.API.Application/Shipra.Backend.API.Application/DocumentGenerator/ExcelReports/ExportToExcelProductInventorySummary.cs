...
public sealed class ExportToExcelProductInventorySummary
{
  public byte[] ExportToExcel(dynamic data, string title)
  {
    ...
    #endregion
    string[] columnsToTake = { "ProductName", "TotalSku", "TotalQuantityCommited", "TotalQuantityAvailable", "TotalQuantityInComing", "TotalQuantityOnOrder", "TotalPrice" };
    bool showSrNo = true;
