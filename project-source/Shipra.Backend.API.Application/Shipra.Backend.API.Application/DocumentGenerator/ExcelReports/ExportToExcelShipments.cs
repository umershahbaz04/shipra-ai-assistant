...
public class ExportToExcelShipments
{
  public byte[] ExportToExcel(dynamic data, string title)
  {
    ...
    #endregion
    string[] columnsToTake = { "OrderNo", "OrderDate", "CreatedOn", "Amount", "CarrierTrackingNo", "CarrierTrackingStatus", "TrackingStatus", "Description", "Remarks", "FullFillmentStatus", "ItemsCount", "PaymentStatus", "Weight", "ItemValue", "ProductStationName", "Discount", "VAT", "StoreName", "StoreAddress", "CustomerServiceNo", "OrderTypeName", "CustomerName", "CustomerFullAddress", "Mobile1", "CountryName", "RegionName", "CityName" };
    bool showSrNo = true;
