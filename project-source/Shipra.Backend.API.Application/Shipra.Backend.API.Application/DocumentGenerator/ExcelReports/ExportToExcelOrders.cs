...
public class ExportToExcelOrders
{
  public byte[] ExportToExcel(dynamic data, string title)
  {
    ...
    if (!IsDataEmpty)
    {
      ...
      dataTable.Columns.Remove("RowNum");
    }
    #endregion

    string[] columnsToTake = { "OrderNo", "RefNo", "OrderDate", "CreatedOn", "Amount", "CarrierTrackingNo", "CarrierTrackingStatus", "TrackingStatus", "Description", "Remarks", "FullFillmentStatus", "ItemsCount", "PaymentStatus", "Weight", "ItemValue", "ProductStationName", "Discount", "VAT", "StoreName", "StoreAddress", "CustomerServiceNo", "OrderTypeName", "CustomerName", "CustomerFullAddress", "Mobile1", "CountryName", "RegionName", "CityName", "NumberOfPieces" };
    bool showSrNo = true;
