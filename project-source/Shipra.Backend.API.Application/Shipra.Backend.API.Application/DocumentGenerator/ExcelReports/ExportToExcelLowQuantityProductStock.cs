...
public class ExportToExcelLowQuantityProductStock
{
  public byte[] ExportToExcel(dynamic data, string title)
  {
    ...
    string[] columnsToTake = { "StationName","ProductName","ProductSku",   "SKU", "VarientOption", "QuantityAvailable", "LowQuantityLimit", "Price" };
    bool showSrNo = true;
