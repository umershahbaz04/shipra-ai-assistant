...
public static class ExcelReader
{
  ...
  {
    return GetDataToList(filePath, "", addProductData);
  }
  ...
  {
    var idx = list.IndexOf(name.ToLower());
    if (idx < 0)
    {
  ...
  {
    int outNum;
    return int.TryParse(source, out outNum) ? outNum : null;
  }
  ...
  {
    decimal outNum;
    return decimal.TryParse(source, out outNum) ? outNum : null;
  }
  ...
  {
    double outNum;
    return double.TryParse(source, out outNum) ? outNum : null;
  }
  ...
  {
    Guid outGuid;
    return Guid.TryParse(source, out outGuid) ? outGuid : null;
  }
  #endregion
