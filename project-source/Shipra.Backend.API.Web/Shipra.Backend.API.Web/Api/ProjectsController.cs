...
//  public ProjectsController(IRepository<Project> repository, IServiceProvider serviceProvider) : base(serviceProvider)
//  {
...
//    var toDoItem = project.Items.FirstOrDefault(item => 1 == itemId);
